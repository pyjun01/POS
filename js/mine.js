...
tm.addEventListener("click",() => {
    let mine_tab=document.querySelector("#mine>.modal_main");
    let mine_code=`
<div id="form">
...
`;
    mine_tab.innerHTML= mine_code;
    mine_start_btn=document.querySelector("#mine>.modal_main>#form #btn");
    mine_start_btn.addEventListener("click",() =>{
        for(var i=0;i<=2;i++){
        ...
        let mine_space=document.querySelectorAll(".c");
        console.log(mine_space);
        for(var i=0;i<mine_space.length;i++){
            mine_space.addEventListener("click",function(e){
                console.log(this);
            //    cy=this.index();// 가로
